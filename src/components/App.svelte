...
<main on:click={closeDropdown}>
  <h1 style="line-height: 1.25">Pioneering Sustainability: Iceland's Per Capita Energy Consumption Surpasses the World's Average,<br>Powered by Low Carbon Innovations</h1>
